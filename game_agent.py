...
def custom_score(game, player):
    ...
    This heuristic maximizes number of movements of the current player and reduces
...
def custom_score_2(game, player):
    ...
    priorizing deffense by a factor 2.
...
class MinimaxPlayer(IsolationPlayer):
    ...
    def _terminal_state(self, game):
        """Returns if the current state is terminal or not.
        Parameters
        ----------
        game : isolation.Board
        ...
        ----------
        bool
            True if it is terminal and False if not.
        """
